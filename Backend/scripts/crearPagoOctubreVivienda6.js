...
const crearPagoOctubreVivienda6 = async () => {
  try {
    console.log('🔗 Conectando a MongoDB...');
    await mongoose.connect(process.env.MONGODB_URI);
    console.log('✅ Conectado a MongoDB');

    console.log('\n🔧 CREANDO PAGO PENDIENTE PARA VIVIENDA 6 - OCTUBRE 2025');
    console.log('=======================================================');
    ...
    // Crear un pago pendiente para octubre 2025
    const mes = 10;
    const año = 2025;

    // Verificar si ya existe un pago para octubre
    ...
    if (pagoExistente) {
      ...
      console.log(`   Estado: ${pagoExistente.estado}`);
      console.log(`   Monto: $${pagoExistente.monto}`);
      return;
    }
